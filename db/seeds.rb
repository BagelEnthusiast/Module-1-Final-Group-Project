...
#enemies
dragon = Enemy.create(name: "Dragon", temp_health: 100, perm_health: 100, speed: 6, attack: 15, defense: 15)
whale = Enemy.create(name: "Whale", temp_health: 150, perm_health: 150, speed: 2, attack: 6, defense: 12)
eagle = Enemy.create(name: "Eagle", temp_health: 30, perm_health: 30, speed: 15, attack: 20, defense: 4)
